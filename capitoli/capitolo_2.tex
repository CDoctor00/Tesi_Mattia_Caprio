...
\begin{itemize}
    ...
    \centering
    \includegraphics[width=0.6\linewidth]{figure/capitolo_2/DW - Single Tier Architetcure.pdf}
    ...
    \begin{figure}[H]
    \centering
    \includegraphics[width=0.6\linewidth]{figure/capitolo_2/DW - Double Tier Architetcure.pdf}
