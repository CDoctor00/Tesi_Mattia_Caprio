...
\begin{itemize}
    ...
    \centering
    \includegraphics[width=0.65\linewidth]{figure/capitolo_2/DW - Single Tier Architetcure.pdf}
    ...
    \begin{figure}[H]
    \centering
    \includegraphics[width=0.65\linewidth]{figure/capitolo_2/DW - Double Tier Architetcure.pdf}
